...
console.log("GROUP BY RESULT:",purchasesByMonth);
// Bonus Points
const totalByMonth = _.reduce(purchasesByMonth, function(result, price){
  console.log("CURRENT TOTAL:",result,"CURRENT VALUE: ", price)
  return result =+ price.reduce((t, p) => t+p.price);
}, 0); // Use the grouped purchasesByMonth and reduce to create a totalByMonth object.
console.log("total is " + totalByMonth);
